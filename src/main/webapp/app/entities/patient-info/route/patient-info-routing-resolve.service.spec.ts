...
import patientInfoResolve from './patient-info-routing-resolve.service';

describe('PatientInfo routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: PatientInfoService;
  let resultPatientInfo: IPatientInfo | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IPatientInfo returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        patientInfoResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultPatientInfo).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IPatientInfo>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
