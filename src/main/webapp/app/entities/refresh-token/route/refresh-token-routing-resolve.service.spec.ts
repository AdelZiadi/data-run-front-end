...
import refreshTokenResolve from './refresh-token-routing-resolve.service';

describe('RefreshToken routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: RefreshTokenService;
  let resultRefreshToken: IRefreshToken | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IRefreshToken returned by find', () => {
      ...
      TestBed.runInInjectionContext(() => {
        refreshTokenResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultRefreshToken).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IRefreshToken>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
