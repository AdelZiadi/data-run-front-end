...
import { sampleWithRequiredData } from '../refresh-token.test-samples';
...
describe('RefreshToken Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, RefreshTokenComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to refreshTokenService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRefreshTokenIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRefreshTokenIdentifier).toHaveBeenCalledWith(entity);
