      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            campaignCode: expect.any(Object),
            campaignStartedDate: expect.any(Object),
            campaignDays: expect.any(Object),
            campaignYear: expect.any(Object),
            campaignNote: expect.any(Object),
