...
import { sampleWithRequiredData } from '../campaign.test-samples';
...
describe('Campaign Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, CampaignComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to campaignService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCampaignIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCampaignIdentifier).toHaveBeenCalledWith(entity);
